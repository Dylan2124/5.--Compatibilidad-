-- ====================================================================
-- SCRIPT SQL COMPLETO: CONFIGURACIÓN Y DATOS DE PRUEBA (COMPATIBILIDAD)
-- Diseñado para copiar y pegar directamente en phpMyAdmin, DBeaver, etc.
-- ====================================================================

-- 1. CREACIÓN DE LA BASE DE DATOS (Si no existe)
CREATE DATABASE IF NOT EXISTS db_compatibilidad CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
